          ...
          >
            ...
            <Grid item xs={12} sm={10}>
              <FormControl fullWidth>
                <InputLabel id="activity">Acitivité</InputLabel>
                <Select
                  labelId="activity"
                  id="activity"
                  name='activity'
                ...
                >
                  <MenuItem value={'journée complète'}>Journée complète</MenuItem>
                  <MenuItem value={'demi-journée'}>Demi-journée</MenuItem>
                  <MenuItem value={'sur-mesure'}>Journée sur-mesure</MenuItem>
                </Select>
              </FormControl>
            </Grid>
          </Grid>
